...
const (
	...
	DeploymentStatusReasonAnnotation = "uccp.io/deployment.status-reason"
	...
	DeploymentPodAnnotation = "uccp.io/deployer-pod.name"
	...
	DeploymentConfigAnnotation = "uccp.io/deployment-config.name"
	...
	DeploymentCancelledAnnotation = "uccp.io/deployment.cancelled"
	...
	// This is set on replication controller by deployer controller.
	DeploymentEncodedConfigAnnotation = "uccp.io/encoded-deployment-config"
	...
	DeploymentVersionAnnotation = "uccp.io/deployment-config.latest-version"
	...
	DeployerPodForDeploymentLabel = "uccp.io/deployer-pod-for.name"

	// DeploymentStatusAnnotation is an annotation name used to retrieve the DeploymentPhase of
	// a deployment.
	// This is set on replication controller by deployer controller.
	DeploymentStatusAnnotation = "uccp.io/deployment.phase"
)
