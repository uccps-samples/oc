...
var buildsResource = schema.GroupVersionResource{Group: "build.uccp.io", Version: "v1", Resource: "builds"}

var buildsKind = schema.GroupVersionKind{Group: "build.uccp.io", Version: "v1", Kind: "Build"}
...
func (c *FakeBuilds) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(buildsResource, c.ns, name), &buildv1.Build{})
