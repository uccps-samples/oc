...
var usersResource = schema.GroupVersionResource{Group: "user.uccp.io", Version: "v1", Resource: "users"}

var usersKind = schema.GroupVersionKind{Group: "user.uccp.io", Version: "v1", Kind: "User"}
