...
var rolesResource = schema.GroupVersionResource{Group: "authorization.uccp.io", Version: "v1", Resource: "roles"}

var rolesKind = schema.GroupVersionKind{Group: "authorization.uccp.io", Version: "v1", Kind: "Role"}
...
func (c *FakeRoles) Get(ctx context.Context, name string, options v1.GetOptions) (result *authorizationv1.Role, err error) {
	...
	return obj.(*authorizationv1.Role), err
}
...
func (c *FakeRoles) List(ctx context.Context, opts v1.ListOptions) (result *authorizationv1.RoleList, err error) {
	...
	list := &authorizationv1.RoleList{ListMeta: obj.(*authorizationv1.RoleList).ListMeta}
	for _, item := range obj.(*authorizationv1.RoleList).Items {
...
func (c *FakeRoles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(rolesResource, c.ns, name, opts), &authorizationv1.Role{})
