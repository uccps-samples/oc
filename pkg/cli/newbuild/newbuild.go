...
var (
	...
	newBuildExample = templates.Examples(`
		...
		oc new-build centos/nodejs-8-centos7~https://github.com/uccps-samples/nodejs-ex.git
		...
		oc new-build https://github.com/uccps-samples/ruby-hello-world --source-image=openshift/jenkins-1-centos7 --source-image-path=/var/lib/jenkins:tmp
	`)
...
default container image registry.
  ...
  oc new-build https://github.com/uccps-samples/nodejs-ex.git
