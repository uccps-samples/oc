...
var (
	credentialsRequestGVK = schema.GroupVersionKind{Group: "cloudcredential.uccp.io", Version: "v1", Kind: "CredentialsRequest"}
...
func NewExtract(f kcmdutil.Factory, streams genericclioptions.IOStreams) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: templates.LongDesc(`
			...
			Extracts the contents of an Uccp release image to disk for inspection or
			...
			--command for either 'oc' or 'uccp-install' will extract the binaries directly.
	...
	flags.StringVar(&o.Command, "command", o.Command, "Specify 'oc' or 'uccp-install' to extract the client for your operating system.")
