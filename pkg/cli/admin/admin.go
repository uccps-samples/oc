...
import (
	...
	"github.com/uccps-samples/oc/pkg/cli/admin/buildchain"
	"github.com/uccps-samples/oc/pkg/cli/admin/catalog"
	"github.com/uccps-samples/oc/pkg/cli/admin/cert"
	"github.com/uccps-samples/oc/pkg/cli/admin/createbootstrapprojecttemplate"
	"github.com/uccps-samples/oc/pkg/cli/admin/createerrortemplate"
	"github.com/uccps-samples/oc/pkg/cli/admin/createkubeconfig"
	"github.com/uccps-samples/oc/pkg/cli/admin/createlogintemplate"
	"github.com/uccps-samples/oc/pkg/cli/admin/createproviderselectiontemplate"
	"github.com/uccps-samples/oc/pkg/cli/admin/groups"
	"github.com/uccps-samples/oc/pkg/cli/admin/inspect"
	"github.com/uccps-samples/oc/pkg/cli/admin/migrate"
	migrateetcd "github.com/uccps-samples/oc/pkg/cli/admin/migrate/etcd"
	migrateimages "github.com/uccps-samples/oc/pkg/cli/admin/migrate/images"
	migratehpa "github.com/uccps-samples/oc/pkg/cli/admin/migrate/legacyhpa"
	migratestorage "github.com/uccps-samples/oc/pkg/cli/admin/migrate/storage"
	migratetemplateinstances "github.com/uccps-samples/oc/pkg/cli/admin/migrate/templateinstances"
	"github.com/uccps-samples/oc/pkg/cli/admin/mustgather"
	"github.com/uccps-samples/oc/pkg/cli/admin/network"
	"github.com/uccps-samples/oc/pkg/cli/admin/node"
	"github.com/uccps-samples/oc/pkg/cli/admin/policy"
	"github.com/uccps-samples/oc/pkg/cli/admin/project"
	"github.com/uccps-samples/oc/pkg/cli/admin/prune"
	"github.com/uccps-samples/oc/pkg/cli/admin/release"
	"github.com/uccps-samples/oc/pkg/cli/admin/top"
	"github.com/uccps-samples/oc/pkg/cli/admin/upgrade"
	"github.com/uccps-samples/oc/pkg/cli/admin/verifyimagesignature"
...
var adminLong = ktemplates.LongDesc(`
	...
	Actions for administering an Uccp cluster are exposed here.`)
