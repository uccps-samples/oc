...
import (
	...
	imgextract "github.com/uccps-samples/oc/pkg/cli/image/extract"
	...
	imgmirror "github.com/uccps-samples/oc/pkg/cli/image/mirror"
)
...
var (
	...
	mirrorExample = templates.Examples(`
		...
		oc delete imagecontentsourcepolicy -l operators.uccp.org/catalog=true
	`)
)
	...
	icsp := operatorv1alpha1.ImageContentSourcePolicy{
		...
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				"operators.uccp.org/catalog": "true",
			},
		},
