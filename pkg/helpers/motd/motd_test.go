...
func TestDisplayMOTD(t *testing.T) {
	var tests = []struct {
		...
		{"Correctly displays message", "\nThis is a legal notice\n", configmap("uccp", "motd", "message", "This is a legal notice")},
		{"No message because of malformed notice (misspelled key)", "", configmap("uccp", "motd", "mesage", "This is a legal notice")},
		{"No message because of misconfigured notice (wrong name)", "", configmap("uccp", "bad-name", "message", "This is a legal notice")},
