...
import (
	...
	fakeprojectclient "github.com/uccps-samples/client-go/project/clientset/versioned/fake"
	fakeprojectv1client "github.com/uccps-samples/client-go/project/clientset/versioned/typed/project/v1/fake"
	fakerouteclient "github.com/uccps-samples/client-go/route/clientset/versioned/fake"
	fakeroutev1client "github.com/uccps-samples/client-go/route/clientset/versioned/typed/route/v1/fake"
	...
	testCases := map[string]struct {
		...
		"with deployment": {
			...
			Contains: []string{
				...
				"bc/ruby-deploy source builds https://github.com/uccps-samples/ruby-ex.git on istag/ruby-25-centos7:latest",
				"not built yet",
			},
			Time: mustParseTime("2015-04-07T04:12:25Z"),
		},
